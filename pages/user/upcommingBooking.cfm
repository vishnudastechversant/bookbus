...
<!--- get total count --->
<cfset upcomming         = createObject("component","bookbus/cfc/userDetails")/>
<cfset upcomming_count   = upcomming.upcommingCount()/> 

<!--- get book list --->
<cfset upcomminglist  = createObject("component","bookbus/cfc/userDetails")/>
<cfset list           = upcomminglist.upcomming(recordperpage,pageno)/> 
...
<div class="buses" id="buses" style="display: block;">
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination">
            <cfloop from="0" to="#upcomming_count-1#" index="i" step="#recordperpage#">
                <cfset y = x++/>
                <cfif pageno eq y>
                    <cfset cl ="active"/>
                <cfelse>
                ...
                <cfoutput>
                    <li class=""><a class="page-link #cl#" href="upcommingBooking.cfm?page=#y#">#y#</a></li>
                </cfoutput>
            </cfloop>
        </ul>
    </nav>
