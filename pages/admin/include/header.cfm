         ...
         <div id="app-sidepanel" class="app-sidepanel">
            ...
            <div class="sidepanel-inner d-flex flex-column">
               ...
               <div class="app-branding">
                  <a class="app-logo" href="index.html"><img class="logo-icon me-2" src="../../assets/admin/images/app-logo.svg" alt="logo"><span class="logo-text">PORTAL</span></a>
               </div>
               <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                  <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="bus_report.cfm">
                           <span class="nav-icon">
                           ...
                           <span class="nav-link-text">Bus Report</span>
                        </a>
                     </li>
                    <!---------------- ADD MENU END HERE ------------------------>
                  </ul>
